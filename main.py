...
def train(args, params):
    ...
    model = darknet.yolo_v8_n(num_classes, img_size=args.img_size).cuda()  # Changed
    ...
    for samples, targets, shapes in p_bar:
        ...
        for i in range(bs):
            ...
            if labels.shape[0]:
                ...
                print(f'No labels for image {i}, filename: {filenames[i]}')
...
def main():
    ...
    parser.add_argument('--save-path', type=str, default='./results/COCO',
                      help='Directory to save model weights and logs')
    parser.add_argument('--dataset-dir', type=str, default='./Dataset/COCO_dark',
