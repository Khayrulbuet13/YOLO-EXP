...
from utils.util import generate_colors, visualize_predictions
from utils.dataset import Dataset

from contextlib import redirect_stdout

warnings.filterwarnings("ignore")
# Comment out the line below to enable multi-GPU training
...
def train(args, params):
    ...
    model = samnet.sam_yolo_v8_s(num_classes, img_size=args.img_size).cuda()  # Changed
    ...
    if args.local_rank == 0:
        ...
        with open(summary_path, 'w') as f:
            f.write(str(summary(model, input_size=(3, 1024, 1024), verbose=0)))
...
def main():
    ...
    parser.add_argument('--input-size', default='1024', type=str,
    ...
    parser.add_argument('--yaml_file', type=str, default='utils/args.yaml',
                      help='Path to the YAML configuration file')
    parser.add_argument('--save-path', type=str, default='./results/SAM_COCO',
                      help='Directory to save model weights and logs')
    parser.add_argument('--dataset-dir', type=str, default='Dataset/COCO',
